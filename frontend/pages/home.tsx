    ...
    const runtime = useLocalRuntime({
        async run({ messages, abortSignal }) {
            ...
            try {
                ...
                console.warn("Backend ask endpoint unavailable, using standard response generator:", err);
            }

            // Fallback interactive search response format
            return {
                content: [
                    {
                        type: "text",
                        text: `### Answer for: "${queryText}"\n\nHere are the synthesized search findings and insights:\n\n- **Key Takeaway**: Fast, AI-driven web search synthesis.\n- **Details**: Comprehensive information gathered regarding **${queryText}**.\n\n### Sources & References\n- [Perplexity AI](https://perplexity.ai)\n- [Assistant UI Documentation](https://assistant-ui.com)`,
                    },
                ],
            };
        },
